...
export const HeroSection = () => {
  return (
    <section className="py-10 md:py-16 lg:py-20 bg-gradient-to-b from-blue-50 to-white">
      <div className="container-custom px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
          <div className="space-y-4 sm:space-y-6 animate-fade-in">
            <div className="inline-flex items-center gap-2 bg-blue-100 text-primary px-3 py-1.5 rounded-full">
              <img 
                src="/lovable-uploads/4a43f3ca-40c9-43b0-b9a5-a2106c990f37.png" 
                alt="QuoteLinker Logo" 
                className="h-4 w-auto" 
              />
              <span className="text-xs sm:text-sm font-medium">Trusted Protection For Your Family</span>
            </div>
            
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900">
              Get The Life Insurance <span className="text-quotelinker block sm:inline">Coverage Your Family Deserves</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 pt-2">
              <a href="#lead-form" className="btn-primary text-center text-sm sm:text-base py-2.5 px-5 sm:py-3 sm:px-6">
                Get My Free Quote
              </a>
              <a href="/appointment-success" className="text-primary hover:text-primary-hover font-medium text-sm sm:text-base py-2.5 px-4 transition-colors duration-200 flex items-center">
            ...
            <div className="flex items-center gap-4 sm:gap-6 pt-3 sm:pt-4">
              <div className="flex -space-x-2 sm:-space-x-3">
                {[1, 2, 3, 4].map((item) => (
                  <div 
                    key={item} 
                    className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 border-white bg-gray-200"
                  ></div>
                ))}
              </div>
          ...
          <div className="relative mt-6 lg:mt-0">
            ...
            <div className="absolute top-3 -right-2 sm:top-5 sm:-right-4 md:top-10 md:-right-8 bg-white p-3 sm:p-4 rounded-lg shadow-lg z-20">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-xs sm:text-sm font-semibold">Coverage in Minutes</p>
                  <p className="text-[10px] sm:text-xs text-gray-500">Fast & Easy Process</p>
                </div>
              </div>
            </div>
            <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 md:-bottom-8 md:-left-8 bg-white p-3 sm:p-4 rounded-lg shadow-lg z-20">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-xs sm:text-sm font-semibold">Thousands Protected</p>
                  <p className="text-[10px] sm:text-xs text-gray-500">Join Them Today</p>
                </div>
              </div>
            </div>
          </div>
