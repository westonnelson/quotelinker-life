...
export const BenefitsSection = () => {
  return <section id="benefits" className="py-16">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map(benefit => <div key={benefit.id} className="card-shadow p-6 flex flex-col items-center text-center">
        ...
        <div className="mt-16 bg-gray-100 p-8 rounded-xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="paragraph mb-6">Speak with a licensed insurance agent to help you understand your options and find the perfect policy for your needs, whether term or permanent life insurance.</p>
            ...
            <div id="appointment-booking" className="bg-white p-6 rounded-lg shadow-md">
              ...
              <a href="#lead-form" className="btn-primary w-full flex justify-center items-center gap-2">
                <Calendar className="h-4 w-4" />
                Book Appointment
              </a>
              <p className="text-xs text-gray-500 mt-4 text-center">No obligation. Cancel or reschedule your life review anytime.</p>
            </div>
          </div>
        </div>
      </div>
